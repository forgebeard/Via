...
| Маршрутизация (правила) | `/onboarding` → **Правила** | Политики доставки в Matrix; старые URL `/routes/*` и `/settings/routes/version` не обслуживаются (`404`) |
